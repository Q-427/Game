...
void LeafManager::spawnLeaf()
{
    ...
    std::uniform_real_distribution<float> verticalDistribution(-75.0f, 75.0f); //y轴偏移
    ...
    leaves.emplace_back(createRandomLeafType(),screenWidth + 30.0f,lastSpawnY); //在可视区域右侧外部生成，然后向左滚动进入画面
